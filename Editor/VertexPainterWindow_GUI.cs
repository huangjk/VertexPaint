...
Tab tab = Tab.Custom;
        ...
        void DrawPaintGUI()
        {
            ...
            {
                brushColorMode = (BrushColorMode)EditorGUILayout.Popup("Blend Mode", (int)brushColorMode, new string[] { "Replace", "Blend" });
            }
            else if (brushMode == BrushTarget.FullColor || brushMode == BrushTarget.UV0_AsColor || brushMode == BrushTarget.UV1_AsColor
            ...
            if (brushMode == BrushTarget.Color || brushMode == BrushTarget.FullColor || brushMode == BrushTarget.UV0_AsColor || brushMode == BrushTarget.UV1_AsColor
            || brushMode == BrushTarget.UV2_AsColor || brushMode == BrushTarget.UV3_AsColor)
            {
                if (brushColorMode == BrushColorMode.Overlay || brushColorMode == BrushColorMode.Normal || brushColorMode == BrushColorMode.Blend)
                {
